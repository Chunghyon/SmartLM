...
public partial class PersonForm : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        {
            if (MessageBox.Show("Áö¹® µ¥ÀÌÅÍ¸¦ Á¦°ÅÇÏ½Ã°Ú½À´Ï±î?", "Áö¹® Á¦°Å",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes) return;
            Person.Fingerprints = new();
            lblFingerprintCount.Text      = "¹Ìµî·Ï";
        ...
        {
            if (MessageBox.Show("Á¤¸Æ µ¥ÀÌÅÍ¸¦ Á¦°ÅÇÏ½Ã°Ú½À´Ï±î?", "Á¤¸Æ Á¦°Å",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes) return;
            Person.Palmveins = new();
            lblPalmveinCount.Text      = "¹Ìµî·Ï";
        ...
        {
            if (MessageBox.Show("»çÁø µ¥ÀÌÅÍ¸¦ Á¦°ÅÇÏ½Ã°Ú½À´Ï±î?", "»çÁø Á¦°Å",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes) return;
        ...
        // ¦¡¦¡ À¯È¿±â°£ ¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡
        mainPanel.Controls.Add(MkLabel("À¯È¿±â°£:"));
    ...
    {
        // À¯È¿±â°£: ¹«Á¦ÇÑÀÌ¸é 2145916799(2037-12-31 23:59:59 UTC, int32-safe), ¾Æ´Ï¸é ¼±ÅÃ ½Ã°¢À» Unix timestamp·Î º¯È¯
        uint expDate = chkNoExpiry.Checked
            ? 4102412399u   // 2099-12-31 23:59:59 KST ? ´Ü¸»±â ½ÇÁ¦ ÃÖ´ë°ª
