...
namespace SBXPCDLLSampleCSharp
{
	public partial class frmLog : Form
    {
            ...
            if (vRet)
            {
                ...
                while (true)
                {
                    ...
                    vRet = sbxpc.SBXPCDLL.GetSuperLogData( Program.gMachineNumber, 
                                                ...
                                                out si.min,
                                                out si.sec);
					sbxpc.SBXPCDLL.GetLastBigUserId_AsString1(Program.gMachineNumber, out si.sEnrollNumber_);
					if (!vRet) break;
					slogs_.Add(si);
        ...
        private void cmdGlogData_Click(object sender, EventArgs e)
        {
            ...
            if (vRet)
            {
				...
				while (true)
				{
					...
					sbxpc.SBXPCDLL.GetLastBigUserId_AsString1(Program.gMachineNumber, out gi.sEnrollNumber_);
					if (!vRet) break;
					glogs_.Add(gi);
        ...
        private void grdGlog_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sbxpc.SBXPCDLL.GeneralOperationXML(Program.gMachineNumber, ref strXML))
            {
                ...
                int nPhotoSize = util.gCompressPhotoSize;
                try
                {
	...
	class SLogInfo
	{
		public string sEnrollNumber_;
		public string sEnrollNumber { get { return sEnrollNumber_; } }
		public int tmno = 0;
	...
	class GLogInfo
	{
        ...
        public string body_temperature
        {
            get
            {
                ...
                int body_temperature_10_delta = (dwGlogExt & 0xFF); // (body_temperature_10_delta: 8, mood: 2, attend_only: 1, reserved: 21)
		...
		public string mood
		{
			get
			{
				int v = ((dwGlogExt >> 8) & 0x3); // (body_temperature_10_delta: 8, mood: 2, attend_only: 1, reserved: 21)
        ...
        public string attend_only
        {
            get
            {
                int v = ((dwGlogExt >> 10) & 0x1); // (body_temperature_10_delta: 8, mood: 2, attend_only: 1, reserved: 21)
