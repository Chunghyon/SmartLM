...
namespace sbxpc
{
    class SBXPCDLL
    {
        ...
        [DllImport(Dll32, EntryPoint = "_ReadGeneralLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadGeneralLogData_GPS_32(Int32 dwMachineNumber, byte bReadMark);
        [DllImport(Dll64, EntryPoint = "_ReadGeneralLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadGeneralLogData_GPS_64(Int32 dwMachineNumber, byte bReadMark);

        public static bool ReadGeneralLogData_GPS(Int32 dwMachineNumber, byte bReadMark)
        {
            if (Environment.Is64BitProcess)
                return _ReadGeneralLogData_GPS_64(dwMachineNumber, bReadMark) > 0;
            else
                return _ReadGeneralLogData_GPS_32(dwMachineNumber, bReadMark) > 0;
        }

        [DllImport(Dll32, EntryPoint = "_ReadGeneralLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadGeneralLogData_GPS_Ext_32(Int32 dwMachineNumber, byte bReadMark);
        [DllImport(Dll64, EntryPoint = "_ReadGeneralLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadGeneralLogData_GPS_Ext_64(Int32 dwMachineNumber, byte bReadMark);

        public static bool ReadGeneralLogData_GPS_Ext(Int32 dwMachineNumber, byte bReadMark)
        {
            if (Environment.Is64BitProcess)
                return _ReadGeneralLogData_GPS_Ext_64(dwMachineNumber, bReadMark) > 0;
            else
                return _ReadGeneralLogData_GPS_Ext_32(dwMachineNumber, bReadMark) > 0;
        }

        [DllImport(Dll32, EntryPoint = "_GetGeneralLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetGeneralLogData_GPS_32(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude);
        [DllImport(Dll64, EntryPoint = "_GetGeneralLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetGeneralLogData_GPS_64(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude);

        public static bool GetGeneralLogData_GPS(Int32 dwMachineNumber, out Int32 dwTMachineNumber, out Int32 dwEnrollNumber, out Int32 dwEMachineNumber, out Int32 dwVerifyMode, out Int32 dwYear, out Int32 dwMonth, out Int32 dwDay, out Int32 dwHour, out Int32 dwMinute, out Int32 dwSecond, out Int32 dwLatitude, out Int32 dwLongitude)
        {
            dwTMachineNumber = 0;
            dwEnrollNumber = 0;
            dwEMachineNumber = 0;
            ...
            byte[] bin_dwMinute = new byte[4];
            byte[] bin_dwSecond = new byte[4];
            byte[] bin_dwLatitude = new byte[4];
            byte[] bin_dwLongitude = new byte[4];
            ...
            GCHandle gh_dwMinute = GCHandle.Alloc(bin_dwMinute, GCHandleType.Pinned);
            GCHandle gh_dwSecond = GCHandle.Alloc(bin_dwSecond, GCHandleType.Pinned);
            GCHandle gh_dwLatitude = GCHandle.Alloc(bin_dwLatitude, GCHandleType.Pinned);
            GCHandle gh_dwLongitude = GCHandle.Alloc(bin_dwLongitude, GCHandleType.Pinned);
            ...
            try
            {
                ...
                IntPtr addr_dwMinute = gh_dwMinute.AddrOfPinnedObject();
                IntPtr addr_dwSecond = gh_dwSecond.AddrOfPinnedObject();
                IntPtr addr_dwLatitude = gh_dwLatitude.AddrOfPinnedObject();
                IntPtr addr_dwLongitude = gh_dwLongitude.AddrOfPinnedObject();

                byte ret = Environment.Is64BitProcess ?
                    _GetGeneralLogData_GPS_64(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
                                ...
                                addr_dwLatitude,
                                addr_dwLongitude) :
                     _GetGeneralLogData_GPS_32(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
                ...
                dwMinute = new BinaryReader(new MemoryStream(bin_dwMinute)).ReadInt32();
                dwSecond = new BinaryReader(new MemoryStream(bin_dwSecond)).ReadInt32();
                dwLatitude = new BinaryReader(new MemoryStream(bin_dwLatitude)).ReadInt32();
                dwLongitude = new BinaryReader(new MemoryStream(bin_dwLongitude)).ReadInt32();
        ...
        [DllImport(Dll32, EntryPoint = "_GetGeneralLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetGeneralLogData_GPS_Ext_32(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude, IntPtr dwGlogExt);
        [DllImport(Dll64, EntryPoint = "_GetGeneralLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetGeneralLogData_GPS_Ext_64(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude, IntPtr dwGlogExt);

        public static bool GetGeneralLogData_GPS_Ext(Int32 dwMachineNumber, out Int32 dwTMachineNumber, out Int32 dwEnrollNumber, out Int32 dwEMachineNumber, out Int32 dwVerifyMode, out Int32 dwYear, out Int32 dwMonth, out Int32 dwDay, out Int32 dwHour, out Int32 dwMinute, out Int32 dwSecond, out Int32 dwLatitude, out Int32 dwLongitude, out Int32 dwGlogExt)
        {
            dwTMachineNumber = 0;
            dwEnrollNumber = 0;
            dwEMachineNumber = 0;
            ...
            try
            {
                ...
                byte ret = Environment.Is64BitProcess ?
                    _GetGeneralLogData_GPS_Ext_64(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
                                ...
                                addr_dwLongitude,
                                addr_dwGlogExt) :
                     _GetGeneralLogData_GPS_Ext_32(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
        ...
        [DllImport(Dll32, EntryPoint = "_ReadAllGLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadAllGLogData_GPS_32(Int32 dwMachineNumber);
        [DllImport(Dll64, EntryPoint = "_ReadAllGLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadAllGLogData_GPS_64(Int32 dwMachineNumber);

        public static bool ReadAllGLogData_GPS(Int32 dwMachineNumber)
        {
            if (Environment.Is64BitProcess)
                return _ReadAllGLogData_GPS_64(dwMachineNumber) > 0;
            else
                return _ReadAllGLogData_GPS_32(dwMachineNumber) > 0;
        }

        [DllImport(Dll32, EntryPoint = "_ReadAllGLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadAllGLogData_GPS_Ext_32(Int32 dwMachineNumber);
        [DllImport(Dll64, EntryPoint = "_ReadAllGLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _ReadAllGLogData_GPS_Ext_64(Int32 dwMachineNumber);

        public static bool ReadAllGLogData_GPS_Ext(Int32 dwMachineNumber)
        {
            if (Environment.Is64BitProcess)
                return _ReadAllGLogData_GPS_Ext_64(dwMachineNumber) > 0;
            else
                return _ReadAllGLogData_GPS_Ext_32(dwMachineNumber) > 0;
        }

        [DllImport(Dll32, EntryPoint = "_GetAllGLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetAllGLogData_GPS_32(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude);
        [DllImport(Dll64, EntryPoint = "_GetAllGLogData_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetAllGLogData_GPS_64(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude);

        public static bool GetAllGLogData_GPS(Int32 dwMachineNumber, out Int32 dwTMachineNumber, out Int32 dwEnrollNumber, out Int32 dwEMachineNumber, out Int32 dwVerifyMode, out Int32 dwYear, out Int32 dwMonth, out Int32 dwDay, out Int32 dwHour, out Int32 dwMinute, out Int32 dwSecond, out Int32 dwLatitude, out Int32 dwLongitude)
        {
            dwTMachineNumber = 0;
            dwEnrollNumber = 0;
            dwEMachineNumber = 0;
            ...
            try
            {
                ...
                byte ret = Environment.Is64BitProcess ?
                    _GetAllGLogData_GPS_64(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
                                ...
                                addr_dwLatitude,
                                addr_dwLongitude) :
                    _GetAllGLogData_GPS_32(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
        ...
        [DllImport(Dll32, EntryPoint = "_GetAllGLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetAllGLogData_GPS_Ext_32(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude, IntPtr dwGlogExt);
        [DllImport(Dll64, EntryPoint = "_GetAllGLogData_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetAllGLogData_GPS_Ext_64(Int32 dwMachineNumber, IntPtr dwTMachineNumber, IntPtr dwEnrollNumber, IntPtr dwEMachineNumber, IntPtr dwVerifyMode, IntPtr dwYear, IntPtr dwMonth, IntPtr dwDay, IntPtr dwHour, IntPtr dwMinute, IntPtr dwSecond, IntPtr dwLatitude, IntPtr dwLongitude, IntPtr dwGlogExt);

        public static bool GetAllGLogData_GPS_Ext(Int32 dwMachineNumber, out Int32 dwTMachineNumber, out Int32 dwEnrollNumber, out Int32 dwEMachineNumber, out Int32 dwVerifyMode, out Int32 dwYear, out Int32 dwMonth, out Int32 dwDay, out Int32 dwHour, out Int32 dwMinute, out Int32 dwSecond, out Int32 dwLatitude, out Int32 dwLongitude, out Int32 dwGlogExt)
        {
            dwTMachineNumber = 0;
            dwEnrollNumber = 0;
            dwEMachineNumber = 0;
            ...
            try
            {
                ...
                byte ret = Environment.Is64BitProcess ?
                    _GetAllGLogData_GPS_Ext_64(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
                                ...
                                addr_dwLongitude,
                                addr_dwGlogExt) :
                    _GetAllGLogData_GPS_Ext_32(dwMachineNumber,
                                addr_dwTMachineNumber,
                                addr_dwEnrollNumber,
                                addr_dwEMachineNumber,
                                addr_dwVerifyMode,
        ...
        [DllImport(Dll32, EntryPoint = "_ReadGLogWithPos_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern bool _ReadGLogWithPos_GPS_32(Int32 dwMachineNumber, Int32 dwStartPos, Int32 dwEndPos);
        [DllImport(Dll64, EntryPoint = "_ReadGLogWithPos_GPS", CallingConvention = CallingConvention.Winapi)]
        static extern bool _ReadGLogWithPos_GPS_64(Int32 dwMachineNumber, Int32 dwStartPos, Int32 dwEndPos);
        public static bool ReadGLogWithPos_GPS(int dwMachineNumber, int dwStartPos, int dwEndPos)
        {
            if (Environment.Is64BitProcess)
                return _ReadGLogWithPos_GPS_64(dwMachineNumber, dwStartPos, dwEndPos);
            else
                return _ReadGLogWithPos_GPS_32(dwMachineNumber, dwStartPos, dwEndPos);
        }

        [DllImport(Dll32, EntryPoint = "_ReadGLogWithPos_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern bool _ReadGLogWithPos_GPS_Ext_32(Int32 dwMachineNumber, Int32 dwStartPos, Int32 dwEndPos);
        [DllImport(Dll64, EntryPoint = "_ReadGLogWithPos_GPS_Ext", CallingConvention = CallingConvention.Winapi)]
        static extern bool _ReadGLogWithPos_GPS_Ext_64(Int32 dwMachineNumber, Int32 dwStartPos, Int32 dwEndPos);
        public static bool ReadGLogWithPos_GPS_Ext(int dwMachineNumber, int dwStartPos, int dwEndPos)
        {
            if (Environment.Is64BitProcess)
                return _ReadGLogWithPos_GPS_Ext_64(dwMachineNumber, dwStartPos, dwEndPos);
            else
                return _ReadGLogWithPos_GPS_Ext_32(dwMachineNumber, dwStartPos, dwEndPos);
        }
        ...
        [DllImport(Dll32, EntryPoint = "_GetDeviceModel", CallingConvention = CallingConvention.Winapi)]
        static extern bool _GetDeviceModel_32(int dwMachineNumber, out int dwIsBigUserId, out int dwCompanyType, out int dwMachineType, out int dwMachineVersion);
        [DllImport(Dll64, EntryPoint = "_GetDeviceModel", CallingConvention = CallingConvention.Winapi)]
        static extern bool _GetDeviceModel_64(int dwMachineNumber, out int dwIsBigUserId, out int dwCompanyType, out int dwMachineType, out int dwMachineVersion);
		public static bool GetDeviceModel(int dwMachineNumber, out int dwIsBigUserId, out int dwCompanyType, out int dwMachineType, out int dwMachineVersion)
		{
            if (Environment.Is64BitProcess)
                return _GetDeviceModel_64(dwMachineNumber, out dwIsBigUserId, out dwCompanyType, out dwMachineType, out dwMachineVersion);
            else
                return _GetDeviceModel_32(dwMachineNumber, out dwIsBigUserId, out dwCompanyType, out dwMachineType, out dwMachineVersion);
        }

        //////////////////////////////////////////////////////////////////////////////
        [DllImport(Dll32, EntryPoint = "_GetLastBigUserId_AsString1", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetLastBigUserId_AsString1_32(
            Int32 dwMachineNumber, Int32 dwIsLocal, out IntPtr lpszStrBase10, out IntPtr lpszStrBase16, out IntPtr lpszStrBase36);
        [DllImport(Dll64, EntryPoint = "_GetLastBigUserId_AsString1", CallingConvention = CallingConvention.Winapi)]
        static extern byte _GetLastBigUserId_AsString1_64(
			Int32 dwMachineNumber, Int32 dwIsLocal, out IntPtr lpszStrBase10, out IntPtr lpszStrBase16, out IntPtr lpszStrBase36);

		public static bool GetLastBigUserId_AsString1(
			Int32 dwMachineNumber, out string lpszStr, bool IsRadix36 = true)
		{
			lpszStr = null;
			IntPtr ptr10;
			IntPtr ptr16;
			...
			try
			{
				bool ret = Environment.Is64BitProcess?
                    _GetLastBigUserId_AsString1_64(dwMachineNumber, 1 /*already on PC*/, out ptr10, out ptr16, out ptr36) > 0 :
                    _GetLastBigUserId_AsString1_32(dwMachineNumber, 1 /*already on PC*/, out ptr10, out ptr16, out ptr36) > 0;
                lpszStr = Marshal.PtrToStringUni(IsRadix36 ? ptr36 : ptr10);
				return ret;
			}
			catch (Exception)
			{
        ...
        [DllImport(Dll32, EntryPoint = "_SetLastBigUserId_AsString1", CallingConvention = CallingConvention.Winapi)]
        static extern byte _SetLastBigUserId_AsString1_32(
            Int32 dwMachineNumber, Int32 dwIsLocal, ref IntPtr lpszStrBase10, ref IntPtr lpszStrBase16, ref IntPtr lpszStrBase36);
        [DllImport(Dll64, EntryPoint = "_SetLastBigUserId_AsString1", CallingConvention = CallingConvention.Winapi)]
        static extern byte _SetLastBigUserId_AsString1_64(
			Int32 dwMachineNumber, Int32 dwIsLocal, ref IntPtr lpszStrBase10, ref IntPtr lpszStrBase16, ref IntPtr lpszStrBase36);

		public static bool SetLastBigUserId_AsString1(
			Int32 dwMachineNumber, string lpszStr, bool IsRadix36 = true)
		{
			if (lpszStr == null)
				return false;

			IntPtr ptr10 = IntPtr.Zero;
			IntPtr ptr16 = IntPtr.Zero;
			IntPtr ptr36 = IntPtr.Zero;
			if(IsRadix36)
				ptr36 = Marshal.StringToHGlobalUni(lpszStr);
			else
				ptr10 = Marshal.StringToHGlobalUni(lpszStr);

			try
			{
                if (Environment.Is64BitProcess)
			    	return _SetLastBigUserId_AsString1_64(dwMachineNumber, 0 /*must transfer to the device*/, ref ptr10, ref ptr16, ref ptr36) > 0;
                else
				    return _SetLastBigUserId_AsString1_32(dwMachineNumber, 0 /*must transfer to the device*/, ref ptr10, ref ptr16, ref ptr36) > 0;
			}
			catch (Exception)
			{
				return false;
		...
		static string BigUserId_Base36_to_Base10(string lpszStrBase36)
		{
			IntPtr ptr10 = IntPtr.Zero;
			IntPtr ptr16 = IntPtr.Zero;
			IntPtr ptr36 = Marshal.StringToHGlobalUni(lpszStrBase36);

            if (Environment.Is64BitProcess)
            {
                _SetLastBigUserId_AsString1_64(1 /*fake*/, 1 /*conversion only, so local*/, ref ptr10, ref ptr16, ref ptr36);
                _GetLastBigUserId_AsString1_64(1 /*fake*/, 1 /*conversion only, so local*/, out ptr10, out ptr16, out ptr36);
            }
            else
            {
                _SetLastBigUserId_AsString1_32(1 /*fake*/, 1 /*conversion only, so local*/, ref ptr10, ref ptr16, ref ptr36);
                _GetLastBigUserId_AsString1_32(1 /*fake*/, 1 /*conversion only, so local*/, out ptr10, out ptr16, out ptr36);
            }

            return Marshal.PtrToStringUni(ptr10);
		}
		static string BigUserId_Base10_to_Base36(string lpszStrBase10)
		{
			IntPtr ptr10 = Marshal.StringToHGlobalUni(lpszStrBase10);
			IntPtr ptr16 = IntPtr.Zero;
			IntPtr ptr36 = IntPtr.Zero;
            ...
            return Marshal.PtrToStringUni(ptr36);
		}
	}
}
