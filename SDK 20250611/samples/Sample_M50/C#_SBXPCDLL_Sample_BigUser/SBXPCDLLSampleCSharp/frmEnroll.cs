...
namespace SBXPCDLLSampleCSharp
{
    public partial class frmEnroll : Form
    {
        ...
        {
            int vEnrollNumber = 1; //fake for interface compatibility
			string sEnrollNumber; //user id as base 36 (0~9 and A~Z mixed) string
            int vEMachineNumber;
            int vFingerNumber;
            int vPrivilege = 0;
            Boolean vRet;
			...
			sEnrollNumber = txtEnrollNumber.Text;
			...
			vRet = sbxpc.SBXPCDLL.SetLastBigUserId_AsString1(Program.gMachineNumber, sEnrollNumber);
        ...
        private void cmdGetAllEnrollData_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
				...
				sbxpc.SBXPCDLL.GetLastBigUserId_AsString1(Program.gMachineNumber, out sEnrollNumber);
            ...
            EEE:
               if (vFingerNumber == 10) vFingerNumber = 15;     // password
                ...
                foreach (DataRow dbRow1 in dbEnrollTble.Rows)
                {
					...
					if ((string)dbRow1["EnrollNumberStr"] == sEnrollNumber)
					{
				...
				dbRow["EnrollNumberStr"] = sEnrollNumber;
            ...
            FFF:
                ...
                lblMessage.Text = String.Format("{0:D2}", vEMachineNumber) + "-" + /*String.Format("{0:D2}", vEnrollNumber)*/sEnrollNumber + "-" + vFingerNumber;
                this.Text = /*String.Format("{0:D2}", vEnrollNumber)*/sEnrollNumber;
                txtEnrollNumber.Text = /*Convert.ToString(vEnrollNumber)*/sEnrollNumber;
        ...
        private void cmdSetAllEnrollData_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dbRow in dbEnrollTble.Rows)
            {
				...
				sEnrollNumber = (string)dbRow["EnrollNumberStr"];
            ...
            FFF:
                ...
                //    LLL:
                lblMessage.Text = "EMachine = " + Convert.ToString(vEMachineNumber) + ", ID = " + /*String.Format("{0:D5}", vEnrollNumber)*/sEnrollNumber + ", FpNo = " + vFingerNumber + ", Count = " + num;
        ...
        private void cmdGetEnrollInfo_Click(object sender, EventArgs e)
        {
            ...
            while (true)
            {
				...
				if (!vRet) break;
                vFlag = true;
                lstEnrollData.Items.Add((String.Format("{0:D5}", i) + "    " + /*String.Format("{0:D5}", vEnrollNumber)*/sEnrollNumber + "    " + String.Format("{0:D3}", vEMachineNumber) + "    " + String.Format("{0:D2}", vFingerNumber) + "    " + Convert.ToString(vPrivilege) + "    " + Convert.ToString(vEnable % 256) + "     " + Convert.ToString(vEnable / 256)));
        ...
        private void cmdModifyDuressFP_Click(object sender, EventArgs e)
        {
			...
			bRet = sbxpc.SBXPCDLL.SetLastBigUserId_AsString1(Program.gMachineNumber, sEnrollNumber);
