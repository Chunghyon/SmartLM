...
namespace sbxpc
{
    class SBXPCDLL
    {
        ...
        static extern byte _XML_AddBinaryUnicode_32(ref IntPtr lpszXML, IntPtr lpszTagname, ref IntPtr lpszData);
        [DllImport(Dll64, EntryPoint = "_XML_AddBinaryUnicode", CallingConvention = CallingConvention.Winapi)]
        static extern byte _XML_AddBinaryUnicode_64(ref IntPtr lpszXML, IntPtr lpszTagname, ref IntPtr lpszData);
        public static bool XML_AddBinaryUnicode(ref string lpszXML, string lpszTagname, string lpszData) // TODO KGH
        {
            ...
            {
                byte ret = Environment.Is64BitProcess ? 
                    _XML_AddBinaryUnicode_64(ref string_in, tag, ref val) :
                    _XML_AddBinaryUnicode_32(ref string_in, tag, ref val);
                lpszXML = Marshal.PtrToStringBSTR(string_in);
                return ret > 0;
            }
            catch (Exception)
