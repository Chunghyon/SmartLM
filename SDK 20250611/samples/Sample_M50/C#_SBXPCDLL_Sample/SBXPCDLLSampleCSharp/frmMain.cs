...
namespace SBXPCDLLSampleCSharp
{
    public partial class frmMain : Form
    {
               ...
               if (lpszDevId.Length >= 6 && lpszDevId.Length <= 16)
                {
                    ...
                    if (Program.gMachineNumber != 0)
                    {
                        ...
                        btnVideoStreaming.Enabled = true;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            btnVideoStreaming.Enabled = false;
        ...
        private void btnVideoStreaming_Click(object sender, EventArgs e)
        {
            frmVideoStreaming frm = new frmVideoStreaming();
            frm.Activate();
            frm.Visible = true;
            this.Visible = false;
        }
