...
namespace SmackBio.WebSocketSDK.Sample
{
    ...
    {
//        private List<SBWebSocketHandler> m_Sessions = new List<SBWebSocketHandler>();
//        private Dictionary<WebSocketSession, SBWebSocketHandler> m_SecureSessions = new List<SBWebSocketHandler>();
...
//         }
        ...
        void StartSuperWebSocketByConfig()
        {
            ...
            secureSocketServer.NewMessageReceived += new SessionHandler<WebSocketSession, string>(securesocketServer_NewMessageReceived);
        ...
        void socketServer_NewSessionConnected(WebSocketSession session)
        {
            ...
            {
                SBWebSocketHandler handler = new SBWebSocketHandler();
                handler.OnOpen(session);
            }
        }
        void socketServer_NewMessageReceived(WebSocketSession session, string e)
        {
            SBWebSocketHandler.getHandler(session).OnMessage(e);
        }
        ...
        void socketServer_SessionClosed(WebSocketSession session, CloseReason reason)
        {
            lock (m_SessionSyncRoot)
            {
                SBWebSocketHandler.getHandler(session).OnClose();
            }
        ...
        void securesocketServer_NewMessageReceived(WebSocketSession session, string e)
        {
            SBWebSocketHandler.getHandler(session).OnMessage(e);
        }
        ...
        {
//             if (m_SecureSocketPushTimer != null)
//             {
