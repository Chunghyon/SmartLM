...
if (0)
{
            alert('ws://<%= Request.Url.Host %>:<%= WebSocketPort %>/sample');
...
{
            alert('wss://<%= Request.Url.Host %>:<%= SecureWebSocketPort %>/SuperWebSocketWeb');

            //setup secure websocket
    		ws = new window[support]('wss://<%= Request.Url.Host %>:<%= SecureWebSocketPort %>/SuperWebSocketWeb');

            //ws = new window[support]('wss://<%= Request.Url.Host %>:9793/wssample');
            //alert('wss://<%= Request.Url.Host %>:9793/wssample');
