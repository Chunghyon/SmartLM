        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnUserManageGerman" runat="server" Text="User Manage (M91 German)" OnClick="btnUserManageGerman_Click" Width="200px" /> <br />
                ...
                <td>
                    ...
                    <br />
                    <asp:Button ID="btnVideoStreaming" runat="server" Text="VideoStreaming" OnClick="btnVideoStreaming_Click" Width="200px" />  <br />
                </td>
            </tr>
        </table>
