    ...
    <tr>
      ...
      <td>
           <table>
               ...
               <tr><td colspan="2">TR Icon Setting(M91 German Only)
                   </td></tr>
               <tr><td>Icon Path(*.png)</td>
                   <td>
                       <asp:TextBox ID="txtIconPath" runat="server" >D:\Tr.png</asp:TextBox>
                   </td>
               </tr>
               <tr><td>Icon No(1~8)</td>
                   <td>
                       <asp:TextBox ID="txtIconNo" runat="server" text="1"/>
                   </td>
               </tr>
               <tr><td>Status(0~2)</td>
                   <td>
                       <asp:TextBox ID="txtIconStatus" runat="server" text="0"/>
                   </td>
               </tr>
               <tr><td>Delete&nbsp;&nbsp;<asp:CheckBox ID="chkDelete" runat="server" /></td>
                   <td>
                       <asp:Button ID="btnSetTrIcon" runat="server" Text="Set" OnClick="btnSetTrIcon_Click" Width="150px" />
                   </td>
               </tr>
           </table>
     </tr>
